...
5x Certified Salesforce Developer with **5.7 years** of experience delivering scalable Salesforce solutions across **BFSI, Technology, and Data Center** domains. Core expertise in LWC, Apex, Flows, REST APIs, SOQL/SOSL, CPQ, and Security Architecture.

- 🔭 Currently working at **PricewaterhouseCoopers (PwC)** as Senior Salesforce Developer
- 🤖 Built **BankSaathi** — an autonomous AI banking agent on Salesforce Agentforce
- 📈 Proven ability to drive **30%+ process automation gains** and **95% on-time Agile delivery**
- 🌱 Exploring **Agentforce, GenAI Functions, and Knowledge-Grounded RAG**
- 💼 Open to exciting Salesforce Developer / Architect opportunities
...
|----------|-------------|
| **Clouds & Platforms** | Sales Cloud · Service Cloud · Experience Cloud · Force.com · BFSI |
| **Apex Development** | Apex · Batch Apex · Schedulable · Queueable · Triggers · Test Classes |
| **Front-End** | Lightning Web Components (LWC) · HTML · CSS · JavaScript |
| **Data & Queries** | SOQL · SOSL · Custom Metadata · Custom Settings · Data Loader |
| **Automation** | Screen Flows · Record-Triggered Flows · Scheduled Flows · Autolaunched Flows |
| **API & Integration** | REST APIs · Apex REST Services · Workato · Dell Boomi |
| **DevOps** | Git · Feature Branching · Pull Requests · CI/CD · Change Sets · Sandbox Management |
| **Agentforce** | Agentforce Studio · GenAI Functions · GenAI Planner · Agent Topics & Actions · Knowledge RAG |
| **Other** | CPQ · OmniStudio · FlexCards · DataRaptors · OmniScripts |

---

## 💼 Experience

### 🏢 PricewaterhouseCoopers (PwC) — Senior Salesforce Developer
**Jan 2025 – Present** | Bangalore

> Client: Vistaar Finance (BFSI – Loan Origination & Servicing)

- Built end-to-end lending platform reducing loan processing time by **25%**
- Developed custom Lead-to-Loan conversion with **100% automated data mapping**
- Implemented metadata-driven Apex trigger framework (Mitch Spano pattern)
- Integrated Razorpay Payment Gateway API for real-time payment processing
- Built **BankSaathi** — autonomous AI banking agent on Agentforce with GenAI Planner & Knowledge RAG

### 🏢 Tata Consultancy Services (TCS) — Salesforce Developer
**Sep 2020 – Jan 2025** | Bangalore

> Clients: Digital Realty (Data Center) · ARM (Semiconductor)

- Achieved **30% reduction** in manual tasks through Flow Builder automation
- Optimized SOQL/SOSL queries reducing execution time by **20%**
- Integrated Salesforce with external systems via Workato — resolving **40% data sync issues**
- Implemented Scheduled Batch Apex saving **20 hours/week**
- Delivered with **95% on-time sprint delivery** in Agile
...
<p align="center">
  <a href="http://www.linkedin.com/in/kirandevireddy"><img src="https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin" /></a>
  <a href="mailto:Kirandevireddy08@gmail.com"><img src="https://img.shields.io/badge/Email-Contact%20Me-D14836?style=for-the-badge&logo=gmail&logoColor=white" /></a>
</p>
